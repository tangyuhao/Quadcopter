...
class main(QtGui.QDialog, Ui_Form):#, Player
    ...
    def on_pushButton_connect_clicked(self):
        ...
        ssh.connect('10.222.98.148', 22, username='lixin', password='171901')
        cmd='ls'
...
def send_CONTROL(ctrl):
    ...
    try:
        ...
        #print 'sended!'
    except Exception as err:    print 'Send_control err!'
...
def send_CHANNEL(throttle,roll,pitch,yaw,mode):
    ...
    try:
        ...
        send_sock.sendall(by)
        #print 'sended!'
    except Exception as err:    print 'Send_channel err!'
        ...
        while True:
            ...
            while True:
                try:
                    ...
                    if ((parity_bit[0]==255)and(parity_bit[1]==170)\
                        and(parity_bit[2]==187)and(parity_bit[3]==204)): #FFAABBCC
